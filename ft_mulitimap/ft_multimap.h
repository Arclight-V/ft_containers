...
#ifndef FT_MULTIMAP_H
#define FT_MULTIMAP_H
...
public:
    ...
    */
     ...
     *
     * explicit multimap (const allocator_type& alloc = allocator_type());
     *
     */
    /*
     *  copy constructor
     ...
     * Returns an iterator pointing to the first element in the multimap container.
     *
     * it begin() {};
     * c_it begin() const {};
     */
     ...
     * Returns a reverse iterator pointing to the theoretical element preceding the first element in the multimap container (which is considered its reverse end).
     *
     * rev_it rend();
     * c_rev_it rend() const;
     */
