...
public:
    ...
    */
     ...
     * Returns an iterator pointing to the first element in the stack container.
     *
     * it begin() {};
     * c_it begin() const {};
     */
     ...
     * Returns a reverse iterator pointing to the theoretical element preceding the first element in the stack container (which is considered its reverse end).
     *
     * rev_it rend();
     * c_rev_it rend() const;
     */
     ...
     * Returns whether the stack container is empty (i.e. whether its size is 0).
     *
     * bool empty() const;
     *
     * Return size
