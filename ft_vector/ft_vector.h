...
public:
    ...
    */
     ...
     * Returns a reverse iterator pointing to the theoretical element preceding the first element in the vector container (which is considered its reverse end).
     *
     * rev_it rend();
     * c_rev_it rend() const;
     */
